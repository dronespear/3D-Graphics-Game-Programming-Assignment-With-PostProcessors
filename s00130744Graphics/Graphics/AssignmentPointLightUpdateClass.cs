...
{
    public class AssignmentPointLightUpdateClass : AssignmentCustomEffectModel
    {
        public class AssignmentLambertPointLightUpdateClassMaterial : Material
        {
            ...
            public AssignmentLambertPointLightUpdateClassMaterial()
            {
        ...
        public AssignmentPointLightUpdateClass(string id, string asset, Vector3 position) : base(id, asset, position)
        {
        ...
        {
            Material = new AssignmentLambertPointLightUpdateClassMaterial();

            AssignmentCustomEffect = GameUtilities.Content.Load<Effect>("Effects\\FinalLightEffect");

            //AssignmentCustomEffect.Parameters["Texture"].SetValue(GameUtilities.Content.Load<Texture2D>("Textures/sand"));
            //AssignmentCustomEffect.Parameters["TextureEnabled"].SetValue(true);
